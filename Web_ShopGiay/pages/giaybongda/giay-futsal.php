...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function sortProducts(sortOption) {
            ...
            xhr.open('GET', 'pages/giaybongda/giay-futsal.php?sort=' + sortOption, true);
...
if (isset($_GET['sort'])) {
    ...
    $sql_pro = "SELECT * FROM tbl_sanpham WHERE loaisp IN ('Giày futsal') AND hangsp IN ('Nike', 'Adidas', 'Puma') $orderBy";
} else {
    // Mặc định sắp xếp theo Mới nhất
    $sql_pro = "SELECT * FROM tbl_sanpham WHERE loaisp IN ('Giày futsal') AND hangsp IN ('Nike', 'Adidas', 'Puma') ORDER BY id_sanpham DESC";
}
