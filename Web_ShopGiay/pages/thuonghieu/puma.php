...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function sortProducts(sortOption) {
            ...
            xhr.open('GET', 'pages/thuonghieu/puma.php?sort=' + sortOption, true);
...
if (isset($_GET['sort'])) {
    ...
    $sql_pro = "SELECT * FROM tbl_sanpham WHERE loaisp IN ('Giày cỏ tự nhiên','Giày cỏ nhân tạo', 'Giày futsal') AND hangsp IN ('Puma') $orderBy";
} else {
    // Mặc định sắp xếp theo Mới nhất
    $sql_pro = "SELECT * FROM tbl_sanpham WHERE (loaisp = 'Giày cỏ tự nhiên' OR loaisp = 'Giày cỏ nhân tạo' OR loaisp = 'Giày futsal') AND hangsp = 'Puma' ORDER BY id_sanpham DESC";
}
