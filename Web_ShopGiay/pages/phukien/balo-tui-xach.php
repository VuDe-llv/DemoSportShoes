...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function sortProducts(sortOption) {
            ...
            xhr.open('GET', 'pages/phukien/balo-tui-xach.php?sort=' + sortOption, true);
...
if (isset($_GET['sort'])) {
    ...
    $sql_pro = "SELECT * FROM tbl_sanpham WHERE loaisp IN ('Balo túi xách') $orderBy";
} else {
    // Mặc định sắp xếp theo Mới nhất
    $sql_pro = "SELECT * FROM tbl_sanpham WHERE loaisp IN ('Balo túi xách') ORDER BY id_sanpham DESC";
}
