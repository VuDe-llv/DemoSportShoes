...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function sortProducts(sortOption) {
            ...
            xhr.open('GET', 'pages/phukien/bao-ve-ong-dong.php?sort=' + sortOption, true);
...
if (isset($_GET['sort'])) {
    ...
    $sql_pro = "SELECT * FROM tbl_sanpham WHERE loaisp IN ('Bảo vệ ống đồng') $orderBy";
} else {
    // Mặc định sắp xếp theo Mới nhất
    $sql_pro = "SELECT * FROM tbl_sanpham WHERE loaisp IN ('Bảo vệ ống đồng') ORDER BY id_sanpham DESC";
}
